...
<template>
    <section class="flex flex-col gap-8 mt-2">
      <h2 class="text-zinc-800 text-2xl md:text-3xl font-bold text-center">PENA KITA<br> <span class="text-xl md:text-2xl text-zinc-800"></span> </h2>
...
<script>
    export default {
      ...
      methods: {
        fetchArticles() {
          fetch("https://server.salmanfrds.com/api/articles") // Use your backend endpoint
