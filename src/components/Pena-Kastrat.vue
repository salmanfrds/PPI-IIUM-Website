...
const fetchAllArticles = async () => {
  try {
    const res = await fetch("https://server.salmanfrds.com/api/articles/pena-kastrat");
...
<template>
  <section class="flex flex-col gap-8">
    <h2 class="text-4xl relative font-bold text-center text-gray-800 mb-">
      ...
      <span class="text-xl md:text-2xl text-gray-600">Kajian Strategis</span>
      <div
      ...
      <div v-for="(article, index) in articles" :key="index"
        ...
        <div class="grid grid-rows-none grid-cols-4">
          <div class="flex-grow flex flex-col col-span-4 md:col-span-3">
            ...
            <div class="flex justify-between items-center text-gray-700 text-xs md:text-sm px-3 py-2">
