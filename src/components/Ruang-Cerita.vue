...
<template>
  <section class="flex flex-col gap-8 mt-2">
    <h2 class="text-gray-800 text-2xl md:text-3xl font-bold text-center">PENA KITA<br> <span class="text-xl md:text-2xl text-gray-600">RUANG CERITA</span> </h2>
...
<script>
    export default {
      ...
      methods: {
        fetchArticles() {
          fetch("https://server.salmanfrds.com/api/articles/ruang-cerita") // Use your backend endpoint
